...
You can see everyone's feedback [here](https://rfortherestofus.com/r-in-3-months-feedback-spring-2023/) 
...
Note that I've added a missing space in a heading purposefully because several submissions lacked a space here.
...
There's a [new lesson about CSS and reference documents](https://rfortherestofus.com/courses/r-in-3-months-spring-2023/lessons/styling-rmarkdown-docs/) for styling RMarkdown reports.

---

### How to preview your knitted documents

![](images/preview-rmd.png)


---

### References and citations in RMarkdown

We had several folks make use of BibTeX for inserting references and citations into their documents.

This is something Charlie is very passionate about so she's added a lesson to the course that she recorded a [few years ago](https://rfortherestofus.com/courses/r-in-3-months-spring-2023/lessons/bibliographies-and-formatting-references/)
...
It's very exciting, but don't feel like you have to drop RMarkdown yet.
]
...
1. Make sure you are working in an RStudio project!
