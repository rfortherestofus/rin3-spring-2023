...
Amy produced this very clean faceted bar chart.

In general, in data visualisation we recommend using line charts for time series.... however, there are some [nuances to that](https://academy.datawrapper.de/article/129-what-to-consider-when-creating-line-charts).

<img src='images/amy-lines-vs-bars.jpg'/>

---

## Annotated barchart [OLD]
...
We'd also like to ask you to record a ~5min video with [loom.com](https://loom.com) about something you've learned thanks to R in 3 Months and submit it on the [final project submission page](https://rfortherestofus.com/courses/r-in-3-months-spring-2023/lessons/rin3-spring-2023-final-project/).
